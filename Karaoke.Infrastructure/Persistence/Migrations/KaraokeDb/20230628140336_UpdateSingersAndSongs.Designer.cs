...
namespace Karaoke.Infrastructure.Persistence.Migrations.KaraokeDb
{
    ...
    [Migration("20230628140336_UpdateSingersAndSongs")]
    partial class UpdateSingersAndSongs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Karaoke.Core.Entities.Culture", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Karaoke.Core.Entities.Song", b =>
                {
                    ...
                    b.HasOne("Karaoke.Core.Entities.Culture", "OriginalLanguage")
                        .WithMany()
